# Spec: backend-summary-boundary

## Purpose

Defines the structural boundaries of the Spring Boot `llm/` package: how outbound ML service calls are isolated in a dedicated client class, how `LlmService` is limited to workflow orchestration, how DTOs are grouped, and how the public API contract is preserved across refactoring.
